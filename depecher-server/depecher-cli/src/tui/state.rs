...
use depecher_client::{AnalyseResponse, DepecherClient, WireOpts};
...
impl MixerApp {
    pub fn new(client: DepecherClient, phrase: String, model: String, tracks: Vec<Track>) -> Self {
