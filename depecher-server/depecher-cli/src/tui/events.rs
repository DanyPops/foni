...
use depecher_client::{SynthRequest, WavData, WireOpts};
...
pub async fn do_render(
    ...
    model: &str,
    opts: WireOpts,
) -> Result<WavData, depecher_client::FoniError> {
...
) -> Result<depecher_client::AnalyseResponse, depecher_client::FoniError> {
