...
//!   1. Environment variables   (`DEPECHER_` prefix, e.g. `DEPECHER_CONTROLLER.DAMPING=0.5`)
...
impl ServerConfig {
    pub fn load() -> ResolvedConfig {
        let figment = Figment::new()
            ...
            .merge(Env::prefixed("DEPECHER_").split("_"));
        ...
        let addr = std::env::var("DEPECHER_SYNTH_ADDR").unwrap_or(cfg.addr);
